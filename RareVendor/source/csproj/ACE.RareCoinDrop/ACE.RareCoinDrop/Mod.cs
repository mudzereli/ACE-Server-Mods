namespace ACE.RareCoinDrop
{
    public class Mod : IHarmonyMod
    {
        ...
        public static string ModPath = Path.Combine(ModManager.ModPath, "ACE.RareCoinDrop");

        //IDs are used by Harmony to separate multiple patches
        const string ID = "com.ACE.ACEmulator.ACE.RareCoinDrop";
        ...
        private LootGenerationFactoryPatch patch = new();
